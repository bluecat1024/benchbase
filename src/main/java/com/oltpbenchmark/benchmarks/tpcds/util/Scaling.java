...
import static com.oltpbenchmark.benchmarks.tpcds.util.Table.S_INVENTORY;
...
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CalendarDistribution.Weights.SALES;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CalendarDistribution.Weights.SALES_LEAP_YEAR;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CalendarDistribution.Weights.UNIFORM;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CalendarDistribution.Weights.UNIFORM_LEAP_YEAR;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CalendarDistribution.getIndexForDate;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CalendarDistribution.getMaxWeight;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CalendarDistribution.getWeightForDayNumber;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.JULIAN_DATE_MAXIMUM;
