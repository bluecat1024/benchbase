...
package com.oltpbenchmark.benchmarks.tpcds.util.generator;
        ...
        implements GeneratorColumn
{
    ...
    private final RowRandomInt randomNumberStream;
    ...
    CatalogSalesGeneratorColumn(int globalColumnNumber, int seedsPerRow)
    {
        ...
        this.randomNumberStream = new RowRandomInt(globalColumnNumber, seedsPerRow);
