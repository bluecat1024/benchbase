...
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_CALL_CENTER_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_CATALOG_PAGE_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_ITEM_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_ORDER_NUMBER;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_EXT_SHIP_COST;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_EXT_TAX;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_FEE;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_NET_LOSS;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_NET_PAID;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_NET_PAID_INC_TAX;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_QUANTITY;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_REFUNDED_CASH;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_REVERSED_CHARGE;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_PRICING_STORE_CREDIT;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_REASON_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_REFUNDED_ADDR_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_REFUNDED_CDEMO_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_REFUNDED_CUSTOMER_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CatalogReturnsGeneratorColumn.CR_REFUNDED_HDEMO_SK;
        ...
        extends TableRowWithNulls
{
    ...
    {
        return List.of(getStringOrNullForKey(crReturnedDateSk, CR_RETURNED_DATE_SK),
