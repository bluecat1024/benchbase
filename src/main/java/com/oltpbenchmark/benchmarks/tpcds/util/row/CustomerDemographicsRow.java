...
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CustomerDemographicsGeneratorColumn.CD_CREDIT_RATING;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CustomerDemographicsGeneratorColumn.CD_DEMO_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CustomerDemographicsGeneratorColumn.CD_DEP_COLLEGE_COUNT;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CustomerDemographicsGeneratorColumn.CD_DEP_COUNT;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CustomerDemographicsGeneratorColumn.CD_DEP_EMPLOYED_COUNT;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CustomerDemographicsGeneratorColumn.CD_EDUCATION_STATUS;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CustomerDemographicsGeneratorColumn.CD_GENDER;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CustomerDemographicsGeneratorColumn.CD_MARITAL_STATUS;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.CustomerDemographicsGeneratorColumn.CD_PURCHASE_ESTIMATE;
        ...
        extends TableRowWithNulls
{
    ...
    {
        return List.of(getStringOrNullForKey(cdDemoSk, CD_DEMO_SK),
