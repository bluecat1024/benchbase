...
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_CHANNEL_CATALOG;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_CHANNEL_DEMO;
...
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_CHANNEL_EMAIL;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_CHANNEL_EVENT;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_CHANNEL_PRESS;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_CHANNEL_RADIO;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_CHANNEL_TV;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_COST;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_DISCOUNT_ACTIVE;
...
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_PROMO_ID;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_PROMO_NAME;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_PROMO_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_PURPOSE;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.PromotionGeneratorColumn.P_RESPONSE_TARGET;
        ...
        extends TableRowWithNulls
{
    ...
    {
        return List.of(getStringOrNullForKey(pPromoSk, P_PROMO_SK),
