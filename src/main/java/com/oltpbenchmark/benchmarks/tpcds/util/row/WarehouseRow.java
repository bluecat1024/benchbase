...
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_CITY;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_COUNTRY;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_COUNTY;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_GMT_OFFSET;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_STATE;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_STREET_NAME1;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_STREET_NUM;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_STREET_TYPE;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_SUITE_NUM;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_ADDRESS_ZIP;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_WAREHOUSE_ID;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_WAREHOUSE_NAME;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WarehouseGeneratorColumn.W_WAREHOUSE_SK;
        ...
        extends TableRowWithNulls
{
    ...
    {
        return List.of(getStringOrNullForKey(wWarehouseSk, W_WAREHOUSE_SK),
