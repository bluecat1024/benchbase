...
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_ITEM_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_ORDER_NUMBER;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_EXT_SHIP_COST;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_EXT_TAX;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_FEE;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_NET_LOSS;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_NET_PAID;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_NET_PAID_INC_TAX;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_QUANTITY;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_REFUNDED_CASH;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_REVERSED_CHARGE;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_PRICING_STORE_CREDIT;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_REASON_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_REFUNDED_ADDR_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_REFUNDED_CDEMO_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_REFUNDED_CUSTOMER_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_REFUNDED_HDEMO_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_RETURNED_DATE_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_RETURNED_TIME_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_RETURNING_ADDR_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_RETURNING_CDEMO_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_RETURNING_CUSTOMER_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_RETURNING_HDEMO_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.WebReturnsGeneratorColumn.WR_WEB_PAGE_SK;
        ...
        extends TableRowWithNulls
{
    ...
    {
        return List.of(getStringOrNullForKey(wrReturnedDateSk, WR_RETURNED_DATE_SK),
