...
import com.oltpbenchmark.benchmarks.tpcds.util.row.DateDimRow;
...
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CalendarDistribution.getIsHolidayFlagAtIndex;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CalendarDistribution.getQuarterAtIndex;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.DateDimGeneratorColumn.D_NULLS;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.CURRENT_QUARTER;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.CURRENT_WEEK;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.TODAYS_DATE;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.WEEKDAY_NAMES;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.computeDayOfWeek;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.computeFirstDateOfMonth;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.computeLastDateOfMonth;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.computeSameDayLastQuarter;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.computeSameDayLastYear;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.fromJulianDays;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Date.getDayIndex;
