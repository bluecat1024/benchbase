...
import com.oltpbenchmark.benchmarks.tpcds.util.distribution.CategoriesDistribution;
import com.oltpbenchmark.benchmarks.tpcds.util.distribution.CategoryClassDistributions.CategoryClass;
import com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions;
import com.oltpbenchmark.benchmarks.tpcds.util.row.ItemRow;
...
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CategoriesDistribution.getCategoryAtIndex;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CategoriesDistribution.getHasSizeAtIndex;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.CategoryClassDistributions.pickRandomCategoryClass;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.EnglishDistributions.SYLLABLES_DISTRIBUTION;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemCurrentPriceDistribution.pickRandomCurrentPriceRange;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions.BRAND_SYLLABLES_DISTRIBUTION;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions.ColorsWeights.SKEWED;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions.IdWeights.UNIFIED;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions.SizeWeights.NO_SIZE;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions.SizeWeights.SIZED;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions.pickRandomColor;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions.pickRandomManufactIdRange;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions.pickRandomSize;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.ItemsDistributions.pickRandomUnit;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_CATEGORY;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_CLASS;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_COLOR;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_CURRENT_PRICE;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_FORMULATION;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_ITEM_DESC;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_MANAGER_ID;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_MANUFACT_ID;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_NULLS;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_PROMO_SK;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_SCD;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_SIZE;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_UNITS;
import static com.oltpbenchmark.benchmarks.tpcds.util.generator.ItemGeneratorColumn.I_WHOLESALE_COST;
import static com.oltpbenchmark.benchmarks.tpcds.util.random.RandomValueGenerator.DIGITS;
...
import static com.oltpbenchmark.benchmarks.tpcds.util.random.RandomValueGenerator.generateUniformRandomDecimal;
import static com.oltpbenchmark.benchmarks.tpcds.util.random.RandomValueGenerator.generateUniformRandomInt;
import static com.oltpbenchmark.benchmarks.tpcds.util.random.RandomValueGenerator.generateUniformRandomKey;
import static com.oltpbenchmark.benchmarks.tpcds.util.random.RandomValueGenerator.generateWord;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.multiply;
