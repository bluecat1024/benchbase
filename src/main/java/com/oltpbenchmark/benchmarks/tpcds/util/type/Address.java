...
import com.oltpbenchmark.benchmarks.tpcds.util.distribution.FipsCountyDistribution;
import com.oltpbenchmark.util.RowRandomInt;

import static com.oltpbenchmark.benchmarks.tpcds.util.PseudoTableScalingInfos.ACTIVE_CITIES;
import static com.oltpbenchmark.benchmarks.tpcds.util.PseudoTableScalingInfos.ACTIVE_COUNTIES;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.AddressDistributions.CitiesWeights.UNIFIED_STEP_FUNCTION;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.AddressDistributions.StreetNamesWeights.DEFAULT;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.AddressDistributions.StreetNamesWeights.HALF_EMPTY;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.AddressDistributions.getCityAtIndex;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.AddressDistributions.pickRandomCity;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.AddressDistributions.pickRandomStreetName;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.AddressDistributions.pickRandomStreetType;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.FipsCountyDistribution.FipsWeights.UNIFORM;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.FipsCountyDistribution.getCountyAtIndex;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.FipsCountyDistribution.getGmtOffsetAtIndex;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.FipsCountyDistribution.getStateAbbreviationAtIndex;
import static com.oltpbenchmark.benchmarks.tpcds.util.distribution.FipsCountyDistribution.getZipPrefixAtIndex;
...
public class Address
{
    ...
    public static Address makeAddressForColumn(Table table, RowRandomInt randomNumberStream, Scaling scaling)
    {
