...
package com.oltpbenchmark.benchmarks.tpcds.util.type;
...
import static com.oltpbenchmark.benchmarks.tpcds.util.random.TPCDSRandomValueGenerator.generateUniformRandomDecimal;
import static com.oltpbenchmark.benchmarks.tpcds.util.random.TPCDSRandomValueGenerator.generateUniformRandomInt;
import static com.oltpbenchmark.benchmarks.tpcds.util.row.generator.CatalogSalesRowGenerator.CS_DISCOUNT_MAX;
import static com.oltpbenchmark.benchmarks.tpcds.util.row.generator.CatalogSalesRowGenerator.CS_MARKUP_MAX;
import static com.oltpbenchmark.benchmarks.tpcds.util.row.generator.CatalogSalesRowGenerator.CS_QUANTITY_MAX;
import static com.oltpbenchmark.benchmarks.tpcds.util.row.generator.CatalogSalesRowGenerator.CS_WHOLESALE_MAX;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.NINE_PERCENT;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.ONE;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.ONE_HALF;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.ONE_HUNDRED;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.ZERO;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.add;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.divide;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.multiply;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.negate;
import static com.oltpbenchmark.benchmarks.tpcds.util.type.Decimal.subtract;
...
public class Pricing
{
    ...
    private static final Map<GeneratorColumn, Limits> LIMITS_PER_COLUMN = Map.of(
    ...
    public static Pricing generatePricingForSalesTable(GeneratorColumn column, RowRandomInt randomNumberStream)
    {
    ...
    public static Pricing generatePricingForReturnsTable(GeneratorColumn column, RowRandomInt randomNumberStream, int quantity, Pricing basePricing)
    {
